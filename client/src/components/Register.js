	...
	return (
		<div className="relative flex w-full h-screen bg-gray-100 overflow-hidden justify-center items-center">
			<div className="z-50 p-6 bg-white rounded-lg shadow-md border flex flex-col items-center space-y-6">
				...
				<form action={ apiBase + "/register"} method="POST" class="text-xl flex flex-col space-y-3 ">
	        		...
	        		<input type="password" name="password" placeholder="Password" className="p-2 rounded-md border bg-gray-100" />
	        		<input type="password" name="token" id="token" placeholder="Register Token" title="hello" className="p-2 rounded-md border bg-gray-100" />
